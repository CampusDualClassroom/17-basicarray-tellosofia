...
class ExerciseTest {
    ...
    void createEmptyIntArray() {
        int[] emptyIntArray = Exercise.createEmptyIntArray(3);
    ...
    void createInitializedStringArray() {
        String[] initializedStringArray = Exercise.createInitializedStringArray();
    ...
    void populateArray() {
        int[] emptyIntArray = Exercise.createEmptyIntArray(3);
        Exercise.populateArray(emptyIntArray,2, 29);
        Exercise.populateArray(emptyIntArray,0,8);
        Exercise.populateArray(emptyIntArray,1,20);
    ...
    void arrayLength() {
        int[] emptyIntArray1 = Exercise.createEmptyIntArray(3);
        int[] emptyIntArray2 = Exercise.createEmptyIntArray(5);
        int[] emptyIntArray3 = Exercise.createEmptyIntArray(7);
        assertEquals(3, Exercise.arrayLength(emptyIntArray1));
        assertEquals(5, Exercise.arrayLength(emptyIntArray2));
        assertEquals(7, Exercise.arrayLength(emptyIntArray3));
    }
    ...
    void showValue() {
        ...
        Exercise.populateArray(emptyIntArray,0,8);
        Exercise.populateArray(emptyIntArray,1,20);
        Exercise.showValue(emptyIntArray,0);
        assertTrue(this.outContent.toString().contains("8"));
        this.outContent.reset();
        Exercise.showValue(emptyIntArray,1);
        assertTrue(this.outContent.toString().contains("20"));
        this.outContent.reset();
        Exercise.showValue(emptyIntArray,2);
